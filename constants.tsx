...
const basicMarkdownToHtml = (md) => {
  ...
  html = html.replace(
    /\[(.*?)\]\((.*?)\)/gim,
    '<a href="$2" target="_blank" style="color: var(--secondary-accent); text-decoration: underline;">$1</a>',
  );
...
<body>
  ...
  json: JSON.stringify(
    ...
    null,
    2,
  ), // Initially pretty-printed for the raw view
  css: `body {
...
const NotepadApp = () => {
  ...
  const toolbarButtonClass =
    "px-3 py-1.5 text-xs rounded-md transition-colors duration-150 focus:outline-none focus:ring-1";
  ...
  const renderContent = () => {
    ...
    return React.createElement("textarea", {
      ...
      className:
        "w-full h-full flex-grow bg-transparent p-3.5 border-none focus:outline-none focus:ring-0 resize-none placeholder-var-text-placeholder text-sm font-mono leading-relaxed",
      style: {
        color: "var(--text-content)",
        fontFamily:
          fileType === "json" || fileType === "css"
            ? "monospace"
            : "sans-serif",
      },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      {
        className:
          "px-2 py-1.5 border-b flex items-center space-x-2 select-none",
        style: {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "absolute left-0 mt-1 w-48 rounded-md shadow-lg py-1 bg-var-secondary-bg ring-1 ring-black ring-opacity-5 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-150 pointer-events-none group-hover:pointer-events-auto",
            style: { backgroundColor: "var(--secondary-bg)", zIndex: 10 },
          } as any,
          React.createElement(
            "a",
            {
              ...
              className: "block px-4 py-2 text-xs hover:bg-var-highlight-bg",
              style: { color: "var(--text-primary)" },
            } as any,
            "Open Sample...",
          ),
      ...
      showPreviewButton &&
        React.createElement(
          "button",
          {
            ...
            style:
              viewMode === "previewMD" || viewMode === "previewHTML"
                ? {
            ...
            onMouseEnter: (e) => {
              if (!(viewMode === "previewMD" || viewMode === "previewHTML"))
                e.currentTarget.style.backgroundColor = "var(--highlight-bg)";
            },
            onMouseLeave: (e) => {
              if (!(viewMode === "previewMD" || viewMode === "previewHTML"))
    ...
    showOpenDialog &&
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "bg-var-secondary-bg p-5 rounded-lg shadow-xl w-full max-w-sm",
            style: {
              backgroundColor: "var(--secondary-bg)",
              color: "var(--text-primary)",
            },
          ...
          React.createElement(
            "div",
            { className: "grid grid-cols-1 gap-2" } as any,
            React.createElement(
              "button",
              {
                onClick: () => handleOpenSample("txt"),
                className: menuButtonClass + " w-full text-left",
                style: { color: "var(--text-primary)" },
              } as any,
          ...
          React.createElement(
            "button",
            {
              ...
              className:
                "mt-4 " +
                toolbarButtonClass +
                " bg-var-danger-accent text-white w-full",
              style: {
...
const SettingsApp = () => {
  const settingItemStyle =
    "p-3.5 border-b flex items-center space-x-3.5 cursor-pointer transition-colors duration-150";
  ...
  const settingsItems = [
    {
      id: "display",
      name: "Display",
      description: "Wallpaper, resolution, themes",
      icon: "https://api.iconify.design/fluent/desktop-pulse-24-regular.svg?color=64FFDA",
    },
    {
      id: "network",
      name: "Network & Internet",
      description: "Wi-Fi, Ethernet, VPN",
      icon: "https://api.iconify.design/fluent/wifi-1-24-regular.svg?color=64FFDA",
    },
    {
      id: "storage",
      name: "Storage",
      description: "Manage local and P2P storage",
      icon: "https://api.iconify.design/fluent/data-usage-settings-24-regular.svg?color=64FFDA",
    },
    {
      id: "privacy",
      name: "Privacy & Security",
      description: "Permissions, encryption",
      icon: "https://api.iconify.design/fluent/shield-keyhole-24-regular.svg?color=64FFDA",
    },
    {
      id: "apps",
      name: "Applications",
      description: "Manage installed applications",
      icon: "https://api.iconify.design/fluent/apps-24-regular.svg?color=64FFDA",
    },
    {
      id: "about",
      name: "About BubbleOS",
      description: "Version, updates, credits",
      icon: "https://api.iconify.design/fluent/info-24-regular.svg?color=64FFDA",
    },
  ];
  ...
  return React.createElement(
    ...
    React.createElement(
      "h2",
      {
        className: "text-lg font-semibold p-4 border-b sticky top-0 z-10",
        style: {
        ...
        React.createElement(
          "div",
          {
            ...
            onMouseLeave: (e) =>
              (e.currentTarget.style.backgroundColor = "transparent"),
            onClick: () =>
              alert(`Navigating to ${item.name} settings (not implemented).`),
            tabIndex: 0,
            role: "button",
          ...
          }), // Alt can be empty as text is present
          React.createElement(
            "div",
            null,
            React.createElement(
            ...
            React.createElement(
              "p",
              {
                className: settingDescriptionStyle,
...
const CalculatorApp = () => {
  ...
  const inputDigit = (digit) => {
    ...
    if (waitingForOperand) {
      ...
      setDisplayValue(
        displayValue === "0" || displayValue === "Error: Div by 0"
          ? String(digit)
          : displayValue + digit,
      );
    }
  ...
  const performOperation = (nextOperator) => {
    ...
    if (prevValue === null) {
      ...
      switch (operator) {
        ...
        case "/":
          result =
            inputValue === 0 ? "Error: Div by 0" : currentValue / inputValue;
          break;
        default:
          return;
      }
  ...
  const buttonBaseClass =
    "font-medium py-3 rounded-lg text-xl transition-all duration-100 focus:outline-none focus:ring-2 focus:ring-opacity-75 active:transform active:scale-95 shadow-md";
  ...
  const buttons = [
    {
      ...
      action: clearAll,
      hoverStyle: styles.specialButtonHover,
    ...
    },
    {
      ...
      hoverStyle: styles.opButtonHover,
    },

    {
      ...
      action: () => inputDigit(7),
      hoverStyle: styles.numButtonHover,
    },
    {
      label: "8",
      style: styles.numButton,
  ...
  const applyHoverStyles = (e, hoverStyle) => {
    if (hoverStyle)
      Object.keys(hoverStyle).forEach(
        (key) => (e.currentTarget.style[key] = hoverStyle[key]),
      );
  };
  const resetStyles = (e, originalStyle) => {
    if (originalStyle)
      Object.keys(originalStyle).forEach(
        (key) => (e.currentTarget.style[key] = originalStyle[key]),
      );
  };
  ...
  return React.createElement(
    "div",
    {
      className: "p-3 h-full flex flex-col font-mono select-none",
    ...
    React.createElement(
      "div",
      {
        id: "calc-display",
        className:
          "text-right text-5xl p-4 rounded-lg mb-3 overflow-x-auto h-24 flex items-center justify-end shadow-inner break-all",
    ...
    React.createElement(
      "div",
      { className: "grid grid-cols-4 gap-2 flex-grow" },
      ...buttons.map((btn) =>
        React.createElement(
          "button",
          {
...
const FileExplorerApp = () => {
  ...
  const sidebarItems = [
    {
      name: "Home",
      icon: "https://api.iconify.design/fluent/home-24-filled.svg?color=64FFDA",
      path: ["Home", "BubbleUser"],
    },
    {
      name: "Documents",
      icon: "https://api.iconify.design/fluent/document-multiple-24-filled.svg?color=64FFDA",
      path: ["Home", "BubbleUser", "Documents"],
    },
    {
      name: "Downloads",
      icon: "https://api.iconify.design/fluent/arrow-download-24-filled.svg?color=64FFDA",
      path: ["Home", "BubbleUser", "Downloads"],
    },
    {
      name: "Pictures",
      icon: "https://api.iconify.design/fluent/image-multiple-24-filled.svg?color=64FFDA",
      path: ["Home", "BubbleUser", "Pictures"],
    },
    {
      name: "BubbleOS Drive",
      icon: "https://api.iconify.design/fluent/cloud-24-filled.svg?color=64FFDA",
      path: ["BubbleOS Drive"],
    },
  ];
  ...
  const getFilesForPath = (pathArray) => {
      ...
      return [
        {
          name: "Project Alpha",
          type: "folder",
          icon: "https://api.iconify.design/fluent/folder-24-filled.svg?color=00A9E0",
        },
        {
          name: "My Novel Draft.docx",
          type: "file",
          icon: "https://api.iconify.design/vscode-icons/file-type-word.svg",
        },
        {
          name: "Meeting Notes.txt",
          type: "file",
          icon: "https://api.iconify.design/vscode-icons/file-type-text.svg",
        },
      ];
    }
    if (pathStr === "Home/BubbleUser/Downloads") {
      return [
        {
          name: "installer_package.zip",
          type: "file",
          icon: "https://api.iconify.design/vscode-icons/file-type-zip.svg",
        },
        {
    ...
    return [
      ...
      },
      {
        name: "Pictures",
        type: "folder",
        icon: "https://api.iconify.design/fluent/folder-image-24-filled.svg?color=00A9E0",
      },
      {
        name: "Music",
        type: "folder",
        icon: "https://api.iconify.design/fluent/folder-music-24-filled.svg?color=00A9E0",
      },
      {
        name: "Downloads",
        type: "folder",
        icon: "https://api.iconify.design/fluent/folder-arrow-down-24-filled.svg?color=00A9E0",
      },
      {
        name: "README.md",
        type: "file",
      ...
      },
      {
        name: "script.js",
        type: "file",
        icon: "https://api.iconify.design/vscode-icons/file-type-js.svg",
      },
    ];
  };
  ...
  const toolbarButtonBase =
    "p-2 rounded-md hover:bg-var-highlight-bg transition-colors duration-150 flex items-center space-x-1.5 text-xs";
  const iconOnlyButtonBase =
    "p-1.5 rounded-md hover:bg-var-highlight-bg transition-colors duration-150";
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      sidebarItems
        .filter((item) =>
          ["Home", "Documents", "Downloads", "Pictures"].includes(item.name),
        )
        .map((item) =>
          React.createElement(
            "button",
      ...
      React.createElement(
        "h3",
        {
          className: "px-2 py-1 text-sm font-semibold mt-4",
          style: { color: "var(--primary-accent)" },
        },
        "Locations",
      ),
      sidebarItems
        .filter((item) => ["BubbleOS Drive"].includes(item.name))
        .map((item) =>
          React.createElement(
            "button",
            {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            "p-2.5 border-b flex items-center justify-between select-none",
          style: {
            borderColor: "rgba(0,0,0,0.08)",
            backgroundColor: "var(--content-bg)",
            color: "var(--text-content)",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("img", {
              src: "https://api.iconify.design/fluent/folder-add-20-regular.svg?color=0A192F",
              alt: "",
              className: "w-4 h-4",
            }),
            "New Folder",
          ...
          React.createElement(
            ...
            React.createElement("img", {
              src: "https://api.iconify.design/fluent/document-add-20-regular.svg?color=0A192F",
              alt: "",
              className: "w-4 h-4",
            }),
            "Upload",
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: iconOnlyButtonBase, title: "Grid View" } as any,
            React.createElement("img", {
              src: "https://api.iconify.design/fluent/grid-dots-20-filled.svg?color=00A9E0",
              alt: "",
              className: "w-4 h-4",
            }),
          ),
          React.createElement(
            "button",
            { className: iconOnlyButtonBase, title: "List View" } as any,
            React.createElement("img", {
              src: "https://api.iconify.design/fluent/text-bullet-list-ltr-20-regular.svg?color=0A192F",
              alt: "",
              className: "w-4 h-4",
            }),
          ),
      ...
      React.createElement(
        "div",
        {
          className: "p-2.5 border-b text-xs select-none",
          style: {
          ...
          files.map((item) =>
            React.createElement(
              "button",
              {
                ...
                className:
                  "p-3 rounded-lg flex flex-col items-center text-center cursor-pointer transition-all duration-150 hover:bg-var-highlight-bg hover:shadow-md focus:outline-none focus:ring-2 focus:ring-var-primary-accent",
                style: {
                  backgroundColor: "transparent",
                  "--hover-bg-var-highlight-bg": "var(--highlight-bg)",
                  "--focus-ring-var-primary-accent": "var(--primary-accent)",
                }, // for JIT
              } as any,
              React.createElement("img", {
                src: item.icon,
...
export const DEFAULT_APPS = [
  ...
  },
  {
    ...
    defaultWidth: 850,
    defaultHeight: 600,
  }, // Increased default size for new layout
  {
    id: "settings",
    name: "Settings",
...
export const WALLPAPER_URL =
  "https://images.unsplash.com/photo-1617503752587-97d2103a96ea?auto=format&fit=crop&w=1920&q=80"; // New colorful, sharp wallpaper
